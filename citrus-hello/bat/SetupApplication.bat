...
:: Android packaging
set AND_CERT_NAME="citrus-hello"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\citrushello.p12
...
set IOS_PROVISION=cert\citrushello.mobileprovision
...
set APP_ID=air.citrushello

:: Output packages
set DIST_PATH=dist
set DIST_NAME=citrushello
