...
:: Android packaging
set AND_CERT_NAME="HelloWorldStarling"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\HelloWorldStarling.p12
...
set IOS_PROVISION=cert\HelloWorldStarling.mobileprovision
...
set APP_ID=air.HelloWorldStarling

:: Output packages
set DIST_PATH=dist
set DIST_NAME=HelloWorldStarling
